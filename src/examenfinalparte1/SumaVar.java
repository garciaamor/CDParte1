 ...
 * Las tres clases se llaman SumaVar, pero se diferencian en el numero de variables que reciben
 * @author jgarciaamor
 */
public class SumaVar {
    ...
    */
    public SumaVar(int j) {
        i = met(j, j);
    }
/**
 * Constructor vacio que no recibe ninguna variable y no devuelve nada, lo unico que hace es asignarle a la variable i el valor -1
 */
    public SumaVar() {
        i = -1;
    }
